...
const ProductDetails = ({ match }) => {
  ...
  const addToCartHandler = () => {
    ...
    alert.success("Produto Adcionado ao Carrinho");
  };
  ...
  useEffect(() => {
    ...
    if (success) {
      alert.success("Obrigado Por Avaliar Este Produto!");
    ...
    <Fragment>
      ...
      {loading ? (
        ...
        <Fragment>
          ...
          <div className="ProductDetails">
            ...
            <div>
              ...
              <div className="detailsBlock-3">
                <h1>{`${[product.price].toLocaleString("pt-br", {
                  style: "currency",
                  currency: "BRL",
                })}`}</h1>
          ...
          <h3 className="reviewsHeading">Avaliações/Comentários</h3>
